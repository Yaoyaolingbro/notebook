...
- 数据库存储在一系列的文件中，每个文件是一系列的记录，每条记录包含一系列的fields
  ...
  - Variable-length records 变长记录
    ...
    - slotted page结构，它的header包含
      ...
      ![image-20200805110144890](./graph/image-20200805110144890.png)
  - 文件中记录的组织方式
    - heap
    - sequential
    - hashing
...
- B+树的相关计算
    ...
    - size大小的估计：也是两种极端情况
        ...
        ![image-20200823175046650](./graph/image-20200823175046650.png)
...
- check point
  ...
  ![image-20200528111132769](./graph/image-20200528111132769.png)
